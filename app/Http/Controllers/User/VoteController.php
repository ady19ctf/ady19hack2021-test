...
class VoteController extends Controller
{
    ...
    {
        //
        return view('user.vote.store')->with('candidate', $request);
    }
...
// ここから下がコピペ
    ...
    public function check(){
        ...
        return view('user.vote.vote-check', compact('user_id', 'user_name'));
    }
...
// 下の部分は将来的にgetCandateDataに含ませる------
        ...
        return view('user.vote.index')->with('candidate_data_with_realname',$candidate_data_with_realname);
    }
    ...
    public function vote(){
        ...
        return view('user.vote.vote-result',['result'=>$output[0]]);
    }
